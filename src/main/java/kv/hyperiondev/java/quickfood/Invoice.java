...
public class Invoice {
	  ...
	  public String generate() throws IOException {
		...
		int orderNumber = genOrderNumber(); 
		
		InvoiceRecords invoiceRecords  = new InvoiceRecords();
	    //save record of invoice to text file
	    invoiceRecords.saveToFile(orderNumber, this.customer.getName(), this.restaurant.getCity());
	    ...
	    try (Formatter writer = new Formatter("data/invoice.txt")) {
	      ...
	      ErrorLog.log("Could not write to data/invoice.txt. "+e.getMessage());
	      return "An error occured generating your invoice";
